export default function DarkModeStyles() {
  return (
    <style dangerouslySetInnerHTML={{ __html: `
      ...
      .dark-theme .hover\\:bg-red-50:hover { background-color: rgba(255,0,0,0.2) !important; }
      ...
      .dark-theme .hover\\:bg-emerald-50:hover { background-color: rgba(16,185,129,0.2) !important; }
      ...
      .dark-theme .hover\\:bg-blue-50:hover { background-color: rgba(59,130,246,0.2) !important; }
      ...
      .dark-theme .hover\\:bg-purple-50:hover { background-color: rgba(168,85,247,0.2) !important; }
      ...
      .dark-theme .hover\\:bg-amber-50:hover { background-color: rgba(245,158,11,0.2) !important; }
      ...
      .dark-theme .hover\\:bg-slate-100:hover { background-color: rgba(148,163,184,0.2) !important; }
